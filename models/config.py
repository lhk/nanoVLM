...
class TrainConfig:
    ...
    eval_interval: int = gradient_accumulation_steps * 1
    stats_log_interval: int = gradient_accumulation_steps * 10
    max_training_steps: int = 50000
    max_images_per_example: int = 1
    max_images_per_knapsack: int = 1
    max_sample_length: int = 1028
    compile: bool = False  # Enable torch.compile by default for better performance
